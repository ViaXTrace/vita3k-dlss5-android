...
## Android DLSS5 Free experiment

This fork contains an optional, free Vulkan post-processing filter named
**DLSS5 Free**. It is an open shader approximation for Android and is not
NVIDIA DLSS, DLSS-NR, or a redistribution of NVIDIA code or models.

The porting notes, current limitations, and the GitHub Actions build path are
